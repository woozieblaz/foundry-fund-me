...
contract FundeMeTest is Test {
    ...
    uint256 constant STARTING_BALACNE = 10 ether;
    ...
    // this modifier is a best practice to help with reapeating codes incase the test gets big
    // this modifier funds our mock contract for our test
    modifier funded() {
        vm.prank(USER);
        fundMe.fund{value: SEND_VALUE}();
        _;
    ...
    function testWithdrawFromMultipleFunder() public funded {
        ...
        // Act
        // vm.prank is thesame as vm.startPrank **** vm.stopPrank just like broadcast
